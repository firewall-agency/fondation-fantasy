        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-3">
              ...
              <a
                href="mailto:fondationfantasy@gmail.com"
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li className="flex items-start gap-2 text-white/70">
                ...
                II Plateau, près SODECI<br />Carrefour mendiant, Abidjan
              </li>
              <li>
              ...
              <li>
                <a href="mailto:fondationfantasy@gmail.com" className="flex items-center gap-2 text-white/70 hover:text-[#22c55e] transition-colors break-all">
